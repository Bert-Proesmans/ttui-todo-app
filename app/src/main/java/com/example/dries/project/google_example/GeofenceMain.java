...
package com.example.dries.project.google_example;
...
import com.example.dries.project.BuildConfig;
import com.example.dries.project.MainActivity;
import com.example.dries.project.R;
 ...
 * <p>
 */
public class GeofenceMain implements OnCompleteListener<Void> {

    private static final String TAG = GeofenceMain.class.getSimpleName();
    ...
    /**
     * Context wherein this class is active
     */
    ...
    public void onCreate(MainActivity linkedContext) {
        ...
        mContext = linkedContext;
        mGeofencingClient = LocationServices.getGeofencingClient(linkedContext);
    }
    ...
    private void showSnackbar(final String text) {
        View container = mContext.findViewById(R.id.main_content_pane);
        if (container != null) {
    ...
    private void showSnackbar(final int mainTextStringId, final int actionStringId,
        ...
        Snackbar.make(
                mContext.findViewById(R.id.main_content_pane),
